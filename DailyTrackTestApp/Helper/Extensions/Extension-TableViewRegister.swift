...
extension UITableView {
    ...
    func setup<T: UITableViewCell>(cellType: T.Type, delegateAndDataSource: UIViewController) {
...
extension UICollectionView {
    ...
    func setup<T: UICollectionViewCell>(cellType: T.Type, delegateAndDataSource: UICollectionViewDelegate & UICollectionViewDataSource) {
        let identifier = String(describing: cellType)
