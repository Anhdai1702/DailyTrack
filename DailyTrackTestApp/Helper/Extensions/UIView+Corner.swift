...
//    
    ...
    func addBlurColor() {
        ...
        blurEffectView.backgroundColor = Constants.color15151CWithSeventyPercent
        self.addSubview(blurEffectView)
        self.sendSubviewToBack(blurEffectView)
    }
    
    func addBaseBorderAndBackground(radius: CGFloat = 16) {
        self.border(radius: radius)
        self.backgroundColor = Constants.colorWhiteWithFourPercent
    }
}
